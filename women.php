...
$winterQuery = "SELECT id, name, price, images FROM women ORDER BY id";
...
<div class="winter-section">
        ...
        <div class="product-grid">
            <?php while ($product = $winterResult->fetch_assoc()): ?>
                ...
                <a href="product.php?id=<?php echo $product['id']; ?>&table=women">
                
                        <img src="<?php echo $mainImage; ?>" alt="<?php echo $product['name']; ?>" class="product-image">
                        <h3><?php echo $product['name']; ?></h3>
                    </a>
                    <p class="product-price">৳ <?php echo number_format($product['price'], 2); ?></p>
                    <a href="product.php?id=<?php echo $product['id']; ?>&table=women" class="view-details-button">View Details</a>
                </div>
            <?php endwhile; ?>
        </div>
    </div>
